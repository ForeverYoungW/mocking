...
public partial class loginHomePage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Params["articleClass"] != null)
        {
            article.DataSource = (from u in db.articles where u.classes.articleClass == Request.Params["articleClass"] select u).ToList();
    ...
    protected void jump1_Click(object sender, EventArgs e)
    {
        using (var db = new BlogEntities())
        {
            try
    ...
    protected void jump2_Click1(object sender, EventArgs e)
    {
        using (var db = new BlogEntities())
        {
            try
